import { IsString, IsOptional, IsNumber, IsArray, ValidateNested, IsUUID, IsObject, Min, Max, IsNotEmpty } from 'class-validator';
...
export class CreateOrderItemDto {
  ...
  @ApiProperty({ description: '单价', example: 12.50, minimum: 0 })
  @IsNumber()
  @Min(0)
  unitPrice: number;
...
export class CreateOrderDto {
  ...
  @ApiProperty({ description: '订单总金额', example: 125.50, minimum: 0 })
  @IsNumber()
  @Min(0)
  totalAmount: number;
