...
export class OrderItemResponseDto {
  ...
  @ApiProperty({ description: "单价", example: 12.5 })
  unitPrice: number;

  @ApiProperty({ description: "总价", example: 125.0 })
  totalPrice: number;
...
export class OrderResponseDto {
  ...
  @ApiProperty({ description: "订单总金额", example: 125.5 })
  totalAmount: number;
  ...
  @ApiPropertyOptional({
    description: "完成时间",
    example: "2025-06-14T16:00:00.000Z",
  })
  completedAt?: Date;
  ...
  @ApiPropertyOptional({
    ...
    example: "https://example.com/order.pdf",
  })
  pdfUrl?: string;
  ...
  @ApiPropertyOptional({
    description: "过期时间",
    example: "2025-06-21T10:30:00.000Z",
  })
  expiresAt?: Date;
