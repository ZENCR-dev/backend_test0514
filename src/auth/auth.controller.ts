...
export class AuthController {
  ...
  @Roles(UserRole.practitioner, UserRole.pharmacy_operator, UserRole.admin, UserRole.patient) // 所有认证用户都可以访问
  @ApiBearerAuth()
  ...
  getAdminData(@Request() req) {
    return { message: `Welcome, Admin ${req.user.email}! This is sensitive admin data.` };
  }
